      ...
      <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="lg:col-span-5">
            <FadeUp>
              <div className="flex items-center gap-2 mb-6">
                <span className="text-xs uppercase tracking-[0.25em] text-coral">Beszéljünk</span>
              </div>
            </FadeUp>
            <FadeUp delay={0.1}>
              <h2 className="font-display text-4xl md:text-5xl leading-[1.05] mb-6 text-balance">
                Vegyük fel a <span className="accent-mark">kapcsolatot.</span>
              </h2>
            </FadeUp>
            <FadeUp delay={0.2}>
        ...
        <div className="border-t border-cream/10 py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-cream/50">
          <div className="flex items-center gap-2">
            <img src={logoWhiteReverse} alt="criticalthinking.hu" className="h-6 w-auto opacity-90" />
          </div>
